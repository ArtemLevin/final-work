...
CREATE TABLE IF NOT EXISTS `human_friends`.`nursery` (
  `nursery_animal_id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `class_name` INT NOT NULL,
...
INSERT human_friends.nursery(nursery_animal_id, class_name, animal_type_name, animal_name, animal_sound, animal_bday)
VALUES
...
INSERT human_friends.horses(class_name,animal_type_name,animal_name,animal_sound,animal_bday)
VALUES
...
WHERE TIMESTAMPDIFF(YEAR, animal_bday, NOW())  BETWEEN 1 and 3;
ALTER TABLE human_friends.young_animals 
ADD animals_age INT;
UPDATE human_friends.young_animals
SET animals_age=TIMESTAMPDIFF(MONTH, animal_bday, NOW());


use human_friends;
create table if not exists final_table
select null, class_name, animal_type_name, animal_name, animal_sound, animal_bday from human_friends.camels
union 
select null, class_name, animal_type_name, animal_name, animal_sound, animal_bday from human_friends.cats
union 
select null, class_name, animal_type_name, animal_name, animal_sound, animal_bday from human_friends.dogs
union 
select null, class_name, animal_type_name, animal_name, animal_sound, animal_bday from human_friends.donkeys
union 
select null, class_name, animal_type_name, animal_name, animal_sound, animal_bday from human_friends.hamsters
union 
select null, class_name, animal_type_name, animal_name, animal_sound, animal_bday from human_friends.horses
union 
select * from human_friends.nursery;